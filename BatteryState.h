...
#ifndef STATUS_GUI_MESSAGE_BATTERYSTATE_H
#define STATUS_GUI_MESSAGE_BATTERYSTATE_H
...
struct BatteryState_
{
  ...
  typedef boost::shared_ptr< ::status_gui::BatteryState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::status_gui::BatteryState_<ContainerAllocator> const> ConstPtr;

}; // struct Battery_

typedef ::status_gui::BatteryState_<std::allocator<void> > BatteryState;

typedef boost::shared_ptr< ::status_gui::BatteryState > BatteryStatePtr;
typedef boost::shared_ptr< ::status_gui::BatteryState const> BatteryStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::status_gui::BatteryState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::status_gui::BatteryState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::status_gui::BatteryState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::status_gui::BatteryState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::status_gui::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::status_gui::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::status_gui::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::status_gui::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::status_gui::BatteryState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::status_gui::BatteryState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7954ad465511faeaULL;
  static const uint64_t static_value2 = 0xe0bd3c9a3ea9b353ULL;
};

template<class ContainerAllocator>
struct DataType< ::status_gui::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "status_gui/BatteryState";
  }
...
template<class ContainerAllocator>
struct Definition< ::status_gui::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::status_gui::BatteryState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::status_gui::BatteryState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::status_gui::BatteryState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // STATUS_GUI_MESSAGE_BATTERYSTATE_H
